...
- 📖 **Tarot Guide Book** — คู่มือไพ่ทาโรต์ฉบับสมบูรณ์ 78 ใบ พร้อมความหมายและ spreads
...
อ้างอิงจาก:
- **[Tarot Guide Book.md](Tarot Guide Book.md)** — คู่มือไพ่ทาโรต์ฉบับสมบูรณ์ 78 ใบ โดย Thanat V.
  - ความหมายทุกหมวด (งาน เงิน รัก สุขภาพ)
  - คำสำคัญสำหรับไพ่ตัวตรงและกลับหัว
  - ธาตุและระบบร่างกายที่เกี่ยวข้อง
  - รูปแบบการวางไพ่ (Spreads) ต่างๆ
  - เคล็ดลับการอ่านไพ่
- ตำราไพ่ทาโรต์ไทย
